    ...
    if(FIO2PIN & (1 << 1)) { // S0 pressed, start update.
        ...
        while(codelen--) {
            ...
            if(ctr == 0x1000 || codelen == 0) { // Transmission complete, write sector.
                while(!(U0LSR & (1<<5)));
                U0THR = 0x13; // Tell host to stop sending.
...
//    const uint8_t key[65] = {0x04, 0xcd, 0x0b, 0x95, 0xcf, 0xda, 0xd5, 0x35, 0xd9, 0x59, 0x1d, 0x3f, 0x82, 0xdd, 0x12, 0x0a,
//                             0x36, 0x63, 0xf2, 0x69, 0xd0, 0x89, 0x0e, 0x5a, 0x50, 0xa0, 0x0f, 0x79, 0x09, 0xe5, 0xc0, 0x4f,
//                             0xe7, 0xc8, 0x2d, 0xc4, 0xbc, 0xc5, 0x74, 0x8f, 0x3d, 0xbe, 0xaa, 0x47, 0x8f, 0x67, 0x99, 0xf5,
//                             0xdc, 0xf7, 0x8e, 0x54, 0xf9, 0x69, 0x39, 0xf6, 0x50, 0xee, 0xe4, 0x57, 0xa3, 0x14, 0xc6, 0x95,
//                             0x10}; // 159XGwSyf1jGcUJDQpGRMnrkUpAgjkgdt7
